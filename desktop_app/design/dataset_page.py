...
"}")
        ...
        self.button_rename_dataset = QtWidgets.QPushButton(self.groupBox)
        self.button_rename_dataset.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.button_rename_dataset.setFont(font)
        self.button_rename_dataset.setObjectName("button_rename_dataset")
        self.verticalLayout_4.addWidget(self.button_rename_dataset)
        ...
        self.button_change_dataset = QtWidgets.QPushButton(self.groupBox_2)
        self.button_change_dataset.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.button_change_dataset.setFont(font)
        self.button_change_dataset.setObjectName("button_change_dataset")
        self.verticalLayout_5.addWidget(self.button_change_dataset)
...
"}")
    ...
    def retranslateUi(self, page_dataset):
        ...
        self.button_rename_dataset.setText(_translate("page_dataset", "Переименовать датасет"))
        ...
        self.button_change_dataset.setText(_translate("page_dataset", "Сменить датасет"))
